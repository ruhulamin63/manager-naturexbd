! function(s, i, r) {
    ...
    r.app.menu = {
        ...
        manualScroller: {
            ...
            update: function() {
                if (this.obj) {
                    ...
                    //     setTimeout(function() { r.app.menu.container.stop().animate({ scrollTop: a }, 300), r(".main-menu").data("scroll-to-active", "false") }, 300)
                    // }
                    this.obj.update()
                }
            },
            enable: function() { r(".main-menu-content").hasClass("ps") || this.init() },
            disable: function() { this.obj && this.obj.destroy() },
            updateHeight: function() { "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu") || !r(".main-menu").hasClass("menu-fixed") || (r(".main-menu-content").css("height", r(s).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight()), this.update()) }
        },
        init: function(e) { if (0 < r(".main-menu-content").length) { this.container = r(".main-menu-content"); var n = ""; if (!0 === e && (n = "collapsed"), "vertical-menu-modern" == l.data("menu")) { this.change(n) } else this.change(n) } },
        drillDownMenu: function(e) { r(".drilldown-menu").length && ("sm" == e || "xs" == e ? "true" == r("#navbar-mobile").attr("aria-expanded") && r(".drilldown-menu").slidingMenu({ backLabel: !0 }) : r(".drilldown-menu").slidingMenu({ backLabel: !0 })) },
        change: function(e, n) {
            ...
            "vertical-menu" !== t && "vertical-menu-modern" !== t || this.toOverlayMenu(a.name, t), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(a.name), r(".menu-toggle").removeClass("is-active")), "horizontal-menu" != t && this.drillDownMenu(a.name), "xl" == a.name && (r('body[data-open="hover"] .dropdown').on("mouseenter", function() { r(this).hasClass("show") ? r(this).removeClass("show") : r(this).addClass("show") }).on("mouseleave", function(e) { r(this).removeClass("show") }), r('body[data-open="hover"] .dropdown a').on("click", function(e) { if ("horizontal-menu" == t && r(this).hasClass("dropdown-toggle")) return !1 })), r(".header-navbar").hasClass("navbar-brand-center") && r(".header-navbar").attr("data-nav", "brand-center"), "sm" == a.name || "xs" == a.name ? r(".header-navbar[data-nav=brand-center]").removeClass("navbar-brand-center") : r(".header-navbar[data-nav=brand-center]").addClass("navbar-brand-center"), r("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) { 0 < r(this).siblings("ul.dropdown-menu").length && e.preventDefault(), e.stopPropagation(), r(this).parent().siblings().removeClass("show"), r(this).parent().toggleClass("show") }), "horizontal-menu" == t && r("li.dropdown-submenu").on("mouseenter", function() {
                ...
                if (e) {
                    ...
                    if (n - a - e.height() - 28 < 1) {
                        var t = n - a - 25;
                        r(this).find(".dropdown-menu").css({ "max-height": t + "px", "overflow-y": "auto", "overflow-x": "hidden" });
            ...
            }), "vertical-menu" !== t && "vertical-overlay-menu" !== t || (jQuery.expr[":"].Contains = function(e, n, a) { return 0 <= (e.textContent || e.innerText || "").toUpperCase().indexOf(a[3].toUpperCase()) }, i = r("#main-menu-navigation"), o = r(".menu-search"), r(o).change(function() {
                var e = r(this).val();
                if (e) {
            ...
            }).keyup(function() { r(this).change() }))
        },
        transit: function(e, n) {
            var a = this;
            l.addClass("changing-menu"), e.call(a), l.hasClass("vertical-layout") && (l.hasClass("menu-open") || l.hasClass("menu-expanded") ? (r(".menu-toggle").addClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").show()) : (r(".menu-toggle").removeClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").hide())), setTimeout(function() { n.call(a), l.removeClass("changing-menu"), a.update() }, 500)
        },
        ...
        hide: function() { this.transit(function() { l.removeClass("menu-open menu-expanded").addClass("menu-hide"), this.hidden = !0, this.expanded = !1, l.hasClass("vertical-overlay-menu") && (r(".sidenav-overlay").removeClass("d-block").addClass("d-none"), r("body").css("overflow", "auto")) }, function() {!r(".main-menu").hasClass("menu-native-scroll") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(), l.hasClass("vertical-overlay-menu") || (r(".sidenav-overlay").removeClass("d-block d-none"), r("body").css("overflow", "auto")) }) },
        ...
        changeMenu: function(e) {
            r('div[data-menu="menu-wrapper"]').html(""), r('div[data-menu="menu-wrapper"]').html(m), r(".menu-livicon").removeLiviconEvo(), r.each(r(".menu-livicon"), function(e) {
                ...
                n.addLiviconEvo({ name: a, style: i, duration: .85, strokeWidth: "1.3px", eventOn: "parent", strokeColor: menuIconColorsObj.iconStrokeColor, solidColor: menuIconColorsObj.iconSolidColor, fillColor: menuIconColorsObj.iconFillColor, strokeColorAlt: menuIconColorsObj.iconStrokeColorAlt, afterAdd: function() { e === r(".main-menu-content .menu-livicon").length - 1 && r(".main-menu-content .nav-item a").on("mouseenter", function() { r(".main-menu-content .menu-livicon").length && (r(".main-menu-content .menu-livicon").stopLiviconEvo(), r(this).find(".menu-livicon").playLiviconEvo()) }) } })
            });
        ...
        reset: function() { this.expanded = !1, this.collapsed = !1, this.hidden = !1, l.removeClass("menu-hide menu-open menu-collapsed menu-expanded") }
    }, r.app.nav = {
        container: r(".navigation-main"),
        initialized: !1,
        navItem: r(".navigation-main").find("li").not(".navigation-category"),
        config: { speed: 300 },
        init: function(e) { this.initialized = !0, r.extend(this.config, e), this.bind_events() },
        bind_events: function() {
            ...
            r(".navigation-main").on("mouseenter.app.menu", "li", function() {
                ...
                e.addClass("hover")
            }).on("mouseleave.app.menu", "li", function() {}).on("active.app.menu", "li", function(e) { r(this).addClass("active"), e.stopPropagation() }).on("deactive.app.menu", "li.active", function(e) { r(this).removeClass("active"), e.stopPropagation() }).on("open.app.menu", "li", function(e) {
                var n = r(this);
                ...
                if ("vertical-menu-modern" == l.data("menu") && (r(".main-menu, .navbar-header").addClass("expanded"), l.hasClass("menu-collapsed"))) {
                    ...
                    var e = r(".main-menu li.menu-collapsed-open"),
                        n = e.children("ul");
                    n.hide().slideDown(200, function() { r(this).css("display", "") }), e.addClass("open").removeClass("menu-collapsed-open")
                }
                ...
                l.hasClass("menu-collapsed") && "vertical-menu-modern" == l.data("menu") && setTimeout(function() {
                    if (0 === r(".main-menu:hover").length && 0 === r(".navbar-header:hover").length && (r(".main-menu, .navbar-header").removeClass("expanded"), l.hasClass("menu-collapsed"))) {
                        var e = r(".main-menu li.open"),
                            n = e.children("ul");
                        e.addClass("menu-collapsed-open"), n.show().slideUp(200, function() { r(this).css("display", "") }), e.removeClass("open")
                    }
                }, 1)
            }), r(".main-menu-content").on("mouseleave", function() { l.hasClass("menu-collapsed") && (r(".main-menu-content").children("span.menu-title").remove(), r(".main-menu-content").children("a.menu-title").remove(), r(".main-menu-content").children("ul.menu-content").remove()), r(".hover", ".navigation-main").removeClass("hover") }), r(".navigation-main li.has-sub > a").on("click", function(e) { e.preventDefault() }), r("ul.menu-content").on("click", "li", function(e) {
                var n = r(this);
        ...
        adjustSubmenu: function(e) {
            var n, a, i, o, t, s = e.children("ul:first"),
                l = s.clone(!0);
            r(".main-menu-header").height(), n = e.position().top, i = d.height() - r(".header-navbar").height(), t = 0, s.height(), 0 < parseInt(e.css("border-top"), 10) && (t = parseInt(e.css("border-top"), 10)), o = i - n - e.height() - 30, r(".main-menu").hasClass("menu-dark"), a = n + e.height() + t, l.addClass("menu-popout").appendTo(".main-menu-content").css({ top: a, position: "fixed", "max-height": o });
            new PerfectScrollbar(".main-menu-content > ul.menu-content", { wheelPropagation: !1 })
        },
        collapse: function(e, n) { e.children("ul").show().slideUp(r.app.nav.config.speed, function() { r(this).css("display", ""), r(this).find("> li").removeClass("is-shown"), n && n(), r.app.nav.container.trigger("collapsed.app.menu") }) },
        expand: function(e, n) {
            var a = e.children("ul"),
                i = a.children("li").addClass("is-hidden");
            a.hide().slideDown(r.app.nav.config.speed, function() { r(this).css("display", ""), n && n(), r.app.nav.container.trigger("expanded.app.menu") }), setTimeout(function() { i.addClass("is-shown"), i.removeClass("is-hidden") }, 0)
        },
        refresh: function() { r.app.nav.container.find(".open").removeClass("open") }
    }
