...
(function(k, H) {
    function Q(b, a) {
        ...
        f =
            x.rect(-19, -19, 4, 4).addClass("lievo-checkshift lievo-donotdraw lievo-nohoverstroke lievo-nohovercolor").attr({ fill: "none", stroke: "#ffffff", "stroke-width": 2, "stroke-linecap": "butt", "stroke-linejoin": "round", opacity: 0 });
        ...
        "round" === a.strokeStyle ? y.forEach(function(a) { "none" === a.attr("stroke") || a.hasClass("lievo-savelinecap") || (a.node.setAttribute("stroke-linecap", "round"), a.node.setAttribute("stroke-linejoin", "round")) }) : "square" === a.strokeStyle && y.forEach(function(a) {
        ...
        var u, F = function() {
            ...
            }), u = 1 / a.scaleStrokeFactor / 2) : (y.forEach(function(a) { "none" !== a.attr("stroke") && a.data("curStrokeWidth", a.data("initStrokeWidth")) }), u = e.select(".lievo-checkshift").attr("stroke-width").replace(/[^0-9.]/g, "") / 2);
        ...
        F();
        if (a.keepStrokeWidthOnResize) k(window).on("resize", function() { F() });
            ...
            d.forEach(function(a) {
                if (a.attr("data-animdata")) {
                    ...
                    b.steps.forEach(function(b) {
                        ...
                        })) : "100%" === b.vars.drawSVG ? (d = g.to(a.node, +b.duration, b.vars), d.eventCallback("onComplete", function() { "square" === a.data("initStrokeLinecap").toLowerCase() && g.set(a.node, { attr: { "stroke-linecap": "square" } }); "miter" === a.data("initStrokeLinejoin").toLowerCase() && g.set(a.node, { attr: { "stroke-linejoin": "miter" } }) })) : d = g.to(a.node, +b.duration, b.vars) : d = g.to(a.node, +b.duration, b.vars) : d = g.to(a.node, +b.duration, b.vars);
        ...
        } else e.selectAll("circle, ellipse, g, image, line, path, polygon, polyline, rect, text, use").forEach(function(a) { a.node.removeAttribute("data-animdata") });
        b.data("drawTL", p);
        b.data("mainTL", n);
        ...
        if (a.animated)
            if (!a.morph)
                if ("click" === a.eventType) a.eventElement.on("click.LiviconEvo", function() {
                    ...
                    if ("hover" ===
                        a.eventType)
                        if (d = function() { a.ending || a.drawn && b.playLiviconEvo() }, l = function() {
                        ...
                        else a.eventElement.on("mouseenter.LiviconEvo", function() { a.drawn && b.playLiviconEvo() })
                }
        else if (a.morph)
            if ("click" === a.eventType) a.eventElement.on("click.LiviconEvo",
                function() { a.drawn && b.playLiviconEvo() });
            else "hover" === a.eventType && (l = function() { a.drawn && n.reverse() }, a.eventElement.on("mouseenter.LiviconEvo", function() { a.drawn && b.playLiviconEvo() }).on("mouseleave.LiviconEvo", l));
        ...
        if (a.touchEvents && (a.animated || a.colorsOnHover || 0 === a.strokeWidthFactorOnHover || a.strokeWidthFactorOnHover)) a.eventElement.on("touchstart.LiviconEvo", function(b) {
            ...
            try { a.eventElement[0].click() } catch (V) {
                ...
                } else "function" === typeof window.MouseEvent && (b = new MouseEvent("click", { bubbles: !0, cancelable: !0 }), a.eventElement.get(0).dispatchEvent(b))
            }
        });
                ...
                if (h.name) {
                    ...
                    k.ajax({
                        ...
                        success: function(b) {
                            ...
                            try { c[0].appendChild(b.node) } catch (u) { c.html(b.node) }
                            Q(a, h);
                ...
                if (d) {
                    ...
                    if (!e.isActive() && !f.isActive() && !d.drawn) {
                        ...
                        f = function() {
                            ...
                            "same" !== p ? (g.set(this.target, { strokeOpacity: 1, stroke: p }), "none" === a.data("curStroke") && a.attr({ "stroke-width": 1 / d.scaleStrokeFactor })) : (g.set(this.target, { strokeOpacity: 1 }), "none" === a.data("curStroke") && a.attr({
                                "stroke-width": 1 /
                                    d.scaleStrokeFactor,
                        ...
                        switch (r) {
                            case "middle":
                                ...
                                break;
                            case "end":
                                e.staggerFromTo(B, u, { drawSVG: "100% 100%" }, { drawSVG: "0% 100%", ease: A, onStart: f, onComplete: z }, F, 0, v);
                                break;
                            default:
                                e.staggerFromTo(B, u, { drawSVG: "0% 0%" }, { drawSVG: "0% 100%", ease: A, onStart: f, onComplete: z }, F, 0, v)
                        }
                        e.restart(!0)
                    }
            ...
            return this.each(function() {
                ...
                if (d) {
                    ...
                    if (!e.isActive() && !f.isActive() &&
                        ...
                        f = function() {
                            "none" === m(this.target).data("curStroke") && m(this.target).attr({ "stroke-width": 1 / d.scaleStrokeFactor, stroke: m(this.target).data("curFill") });
                            g.to(this.target, u, { fillOpacity: 0 })
                        };
                        q = function() {
                            g.set(this.target, { strokeOpacity: 0, fillOpacity: 0 });
                            "none" === m(this.target).data("curStroke") && g.set(this.target, { "stroke-width": 0, stroke: "none" })
                        };
                        var z = function() { d.drawn = !1 };
                        e.clear();
                        ...
                        switch (r) {
                            case "middle":
                                e.staggerFromTo(v, u, { drawSVG: "0% 100%" }, { drawSVG: "50% 50%", ease: p, onStart: f, onComplete: q }, t, 0, z);
                                break;
                            case "end":
                                e.staggerFromTo(v, u, { drawSVG: "0% 100%" }, { drawSVG: "100% 100%", ease: p, onStart: f, onComplete: q }, t, 0, z);
                                break;
                            default:
                                e.staggerFromTo(v, u, { drawSVG: "0% 100%" }, { drawSVG: 0, ease: p, onStart: f, onComplete: q }, t, 0, z)
                        }
                        e.restart(!0)
                    }
            ...
            return this.each(function() {
                ...
                if (d) {
                    ...
                    if (d.animated) {
                        ...
                        t.forEach(function(a) { a.duration(e) });
                        0 >= f && (f = .001);
                        b.delay(f);
