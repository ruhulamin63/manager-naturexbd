                    ...
                    <div class="users-list-filter">
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('city_id', $cityID)->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('city_id', $cityID)->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('city_id', $cityID)->where('created_at', 'LIKE', '%' . date('Y-m-d') . '%')->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('city_id', $cityID)->where('created_at', 'LIKE', '%' . date('Y-m-d') . '%')->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('order_status', 'Pending')->where('city_id', $cityID)->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('order_status', 'Pending')->where('city_id', $cityID)->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('order_status', 'Ongoing')->where('city_id', $cityID)->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('order_status', 'Ongoing')->where('city_id', $cityID)->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('order_status', 'Delivered')->where('city_id', $cityID)->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('order_status', 'Delivered')->where('city_id', $cityID)->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Order::select('*')->where('order_status', 'Cancelled')->where('city_id', $cityID)->get()) }}</h3>
                                            <small>৳ {{ \App\Models\Grocery\Order::where('order_status', 'Cancelled')->where('city_id', $cityID)->sum('total_amount') }} Tk</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12" id="navTop">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ url('/grocery/order') }}" method="GET">
                            ...
                            <div class="col-sm-12" id="changeSchedule" hidden>
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ url('/grocery/order/schedule') }}" method="POST">
                                            @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    @elseif($item->order_status == "Ongoing")
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="badge badge-pill badge-light-success mb-1 round-cursor" onclick="showOrderDetailsWeb('{{ $item->order_data }}', '{{ $item->product_total }}', '{{ $item->delivery_charge }}', '{{ $item->discount }}', '{{ $item->total_amount }}')">Order Details</div>
                                                            @if(strpos($permission, 'print_order_invoice') !== false)
                                                            <a href="{{ url('/grocery/print/invoice?name=' . $item->customer_name . '&order=' . $item->order_id) }}" target="_blank">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="{{ url('/grocery/order/edit?id=' . $item->order_id . '&city=' . Request::get('city')) }}">
                                                        ...
                                                        <a href="{{ url('/payment/tokens/generate/' . $item->order_id) }}">
                                                        ...
                                                        <a href="{{ url('/grocery/order/delete?id=' . $item->order_id) }}">
    ...
    <div class="modal fade text-left" id="cancelRemarks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/grocery/order/cancel') }}" method="GET">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
    ...
    <script>
        ...
        function completeOrder(orderID) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    url = '{{ url("/grocery/order/complete") }}';
                    url = url + "?id=" + orderID;
                    window.location.href = url;
                }
            });
