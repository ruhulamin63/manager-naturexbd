                    ...
                    <div class="users-list-filter">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add New Product Menu</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ url('/restaurant/ProductCategory/create') }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-lg-12">
                                                <input type="text" class="form-control" name="category_name" placeholder="Enter Menu Name" required>
                                            </div>
                                            <div class="col-12 col-sm-12" style="margin-top:15px">
                                                <fieldset class="form-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="inputGroupFile02" name="category_img" required>
                                        ...
                                        <table id="seven-item-datatable" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ date('M d,Y h:m a', strtotime($item->created_at)) }}
                                                    </td>
                                                    @if($item->status == "1")
                                                    <td class="text-center" style="width: 5%">
                                                        ...
                                                        <div class="badge badge-pill badge-danger mb-1 round-cursor" onclick="deleteCategory('{{ $item->id }}')">Delete</div>
                                                    </td>
                                                    @else
                                                    <td class="text-center" style="width: 5%">
                                                        <div class="custom-control custom-switch custom-control-inline mb-1">
    ...
    <script>
        ...
        function statusUpdate(id, item) {
            ...
            $.ajax({
                ...
                url: "{{ url('/restaurant/ProductCategory/updateStatus') }}",
                type: "POST",
                data: {
                    id: id,
                    status: status
        ...
        function deleteCategory(id) {
            $.ajax({
                ...
                url: "{{ url('/restaurant/ProductCategory/deleteCategory') }}",
                type: "POST",
                data: {
                    id: id,
                    status: status
