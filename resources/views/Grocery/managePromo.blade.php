                                                ...
                                                <tr>
                                                    ...
                                                    @endphp
                                                        ...
                                                        @if($item->image)
                                                            ...
                                                            <form action="{{ url('/grocery/managePromo/updatePromoImage/') }}" method="POST" enctype="multipart/form-data">
                                                                @csrf
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" id="editBrandForm" action="{{ url('/grocery/managePromo/editPromo') }}" method="POST">
                @csrf
    ...
    <script>  
        ...
        function statusUpdate(promo_id, item) {
            ...
            $.ajax({
                ...
                url: "{{ url('/grocery/managePromo/updatePromoStatus') }}",
                type: "POST",
                data: {
                    promo_id: promo_id,
                    promo_status: status
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('/grocery/managePromo/deletePromo') }}",
                        type: "POST",
                        data: {
                            promo_id: promo_id,
                            promo_status: status
