                ...
                <section class="users-list-wrapper">
                    <div class="users-list-filter">
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Leads::all()) }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Leads::select('*')->where('status', 'Pending')->get()) }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <h3 class="mb-0">{{ count(\App\Models\Grocery\Leads::select('*')->where('status', 'Resolved')->get()) }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ url('/grocery/leads/upload') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
    ...
    <div class="modal fade text-left" id="remarksModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/grocery/leads/resolve') }}" method="POST">
                    @csrf
