...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                    ...
                                    <form action="{{ url('/grocery/products/create') }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-lg-6 mb-1">
                                                <input type="text" class="form-control" id="customer_name" placeholder="Enter customer name" required autocomplete="off">
                                            </div>
                                            <div class="col-12 col-sm-12 col-lg-6 mb-1">
                                                <fieldset>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control" id="customer_mobile" maxlength="11" aria-describedby="basic-addon1" placeholder="Enter customer mobile number" required autocomplete="off">
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-12 col-sm-12 col-lg-6">
                                                <input type="text" class="form-control" id="delivery_address" placeholder="Enter delivery address" required autocomplete="off">
                                            </div>
                                            <div class="col-12 col-sm-12 col-lg-6">
                                            ...
                                            <div class="col-12 col-sm-12 col-lg-6 mb-1">
                                                <input type="text" class="form-control" id="delivery_note" placeholder="Enter delivery note" value="N/A" required autocomplete="off">
                                            </div>
                                            <div class="col-sm-12 col-12 col-lg-6 mb-1">
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="text" id="scheduled_date" class="form-control format-picker" placeholder="Select Delivery Date" required>
                                            ...
                                            <div class="col-12 col-sm-12" style="margin-top: 10px">
                                                <button type="button" class="btn btn-block btn-success glow" onclick="createOrder()">Create Order</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        ...
        function generateInvoice() {
            ...
            var totalPrice = 0;
            for (i = 0; i < cartItem.length; i++) {
                var row = "<tr><td>" + (i + 1) + "</td><td>" + cartItem[i].productName + "<br><small>" + cartItem[i].productDescription;
        ...
        function createOrder() {
            ...
            if (customerName == "" || customerMobile == "" || customerAddress == "" || customerDivision == "" || customerDivision == "Select Division") {
                ...
                for (i = 0; i < cartItem.length; i++) {
                    if (i == 0) {
                        itemData += '{"a":"' + cartItem[i].productID + '","b":"' + cartItem[i].productName + '","c":"' + cartItem[i].productPrice;
                ...
                $.ajax({
                    ...
                    url: "{{ url('/grocery/order/createWebOrder') }}",
                    type: "POST",
                    data: {
                        city_id: '{{ $cityID }}',
